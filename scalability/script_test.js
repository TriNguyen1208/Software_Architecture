...
export default function () {
    // Lấy URL từ biến môi trường TARGET_URL nếu được truyền vào lúc chạy lệnh (VD: k6 run -e BASE_URL=...), nếu không thì dùng URL mặc định
    const url = __ENV.TARGET_URL || 'http://localhost/productpage';
